...
paquetes <- c("rvest","httr","jsonlite","quantmod","tidyquant","dplyr","lubridate","tidyr","tinytex","purrr","ggplot2","patchwork","forcats","scales","tidyverse","quadprog","ggthemes","viridis","plotly","timetk","PerformanceAnalytics","kableExtra","gridExtra","ggplotify","grid","htmlwidgets")
